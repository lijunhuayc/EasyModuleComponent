...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTabIsCenter = ta.getBoolean(R.styleable.SlidingTabLayout_tl_tab_is_center, true);
     ...
     */
    public void setViewPager(ViewPager vp, List<String> titles, List<Fragment> fragments, FragmentManager fragmentManager) {
        if (vp == null) {
        ...
        if (mViewPager == vp) {
            ...
            if (null != adapter) {
                if (adapter instanceof InnerPagerAdapter) {
                    ...
                    innerPagerAdapter.fragments = fragments;
                    innerPagerAdapter.titles = titles;
    ...
    public void setTabs(List<String> pTitles) {
        if (null != this.mTitles) {
            this.mTitles.clear();
        } else {
            this.mTitles = new ArrayList<>();
        }
        if (null != pTitles && !pTitles.isEmpty()) {
            this.mTitles.addAll(pTitles);
        }
        notifyDataSetChanged();
    }
    ...
    //setter and getter// 仅仅使用 TAB 时, 代码调用此方法不会响应 TAB 的点击监听事件
    ...
    class InnerPagerAdapter extends FragmentPagerAdapter {
        ...
        public InnerPagerAdapter(FragmentManager fm, List<Fragment> fragments, List titles) {
            super(fm);
