 ...
 * 快捷分享的入口
 * <p>
 * 通过不同的setter设置参数，然后调用{@link #show(Context, OnekeyShareThemeImpl.ShareSuccessListener)}方法启动快捷分享
 */
public class OnekeyShare {
    ...
    public void show(Context context, OnekeyShareThemeImpl.ShareSuccessListener l) {
        ...
        themeImpl.setShareSuccessListener(l);
