...
public abstract class OnekeyShareThemeImpl implements PlatformActionListener, Callback {
    ...
    public void setShareSuccessListener(ShareSuccessListener shareSuccessListener) {
        mShareSuccessListener = shareSuccessListener;
    }
            ...
            case 1: {
               ...
               /* int resId = ResHelper.getStringRes(context, "ssdk_oks_share_completed");
                ...
                if (mShareSuccessListener != null) {
                    mShareSuccessListener.shareSuccess();
                }
            }
            break;
            case 2: {
