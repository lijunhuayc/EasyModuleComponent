package com.renxin.cheku.cooldialog;
...
public class CoolDialog extends Dialog {
    ...
    private void setDialogUI() {
        ...
        if (null != window) {
            ...
            int margin = dp2px(getContext(), 16);
...
//            if (params.mIconId != 0 || null != params.mIcon || !TextUtils.isEmpty(params.mTitle)) {
    ...
    public void setMessageIcon(Drawable drawable) {
        ...
        if (null != mMessageView) {
            ...
            mMessageView.setCompoundDrawablePadding(dp2px(getContext(), 35));
        }
        resetMessageArea();
    }

    public void setMessageIcon(int mIconId) {
