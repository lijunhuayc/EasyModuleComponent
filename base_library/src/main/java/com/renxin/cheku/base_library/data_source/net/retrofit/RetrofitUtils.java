package com.renxin.cheku.base_library.data_source.net.retrofit;
...
import com.renxin.cheku.arouter.provider.GlobalHostProvider;
import com.renxin.cheku.base_library.BaseLibraryApplication;
import com.renxin.cheku.base_library.data_source.net.net_okhttp3.OkHttp3CookieJar;
import com.renxin.cheku.base_library.data_source.net.net_okhttp3.OkHttp3Interceptor;
import com.renxin.cheku.base_library.data_source.net.retrofit.converter.CustomConverterFactory;
import com.renxin.cheku.base_library.model.BaseResult;
import com.renxin.cheku.base_library.model.PageBean;
import com.renxin.cheku.base_library.utils.MyToast;
import com.renxin.cheku.base_library.utils.NetworkUtils;
...
import static com.renxin.cheku.base_library.model.BaseResult.STATUS_NETWORK_FAILURE;
import static com.renxin.cheku.base_library.model.BaseResult.STATUS_INTERNAL_ERROR;
...
public class RetrofitUtils {
    ...
    public <API_SERVICE, RESULT> boolean request(Class<API_SERVICE> pClass, RetrofitCallback<API_SERVICE, RESULT> pObtainCallback) {
        ...
        if (null != call) {
            if (NetworkUtils.isNetworkAvailable(BaseLibraryApplication.getApplication())) {
    ...
    public static abstract class RetrofitCallback<API_SERVICE, RESULT> implements Callback<BaseResult<RESULT>> {
        ...
        public void onResponse(Call<BaseResult<RESULT>> call, retrofit2.Response<BaseResult<RESULT>> response) {
            /**
             * @see com.renxin.cheku.base_library.data_source.net.retrofit.converter.CustomResponseBodyConverter
