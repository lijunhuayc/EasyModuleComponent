...
import com.renxin.cheku.base_library.utils.LocalActivityManager;
import com.renxin.cheku.base_library.utils.Timber;
import com.renxin.cheku.cooldialog.CoolLoadingDialog;
...
public abstract class BaseActivity extends BasePermissionActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCoolLoadingDialog = new CoolLoadingDialog.Builder(this).setCancelable(false).create();
        initUI();
        onCreated();
    }
    ...
    protected void onStart() {
        ...
        super.onStart();
//        ReportDataService.getInstance().pageInEvent(this.getClass().getSimpleName(), getPageName());//TODO ...
    }
    ...
    protected void onStop() {
        ...
        super.onStop();
//        ReportDataService.getInstance().pageOutEvent(this.getClass().getSimpleName(), getPageName());//TODO ...
    }
