package com.renxin.cheku.base_library.base.adapter;
...
public abstract class BaseViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
     ...
     */
    protected abstract void bindItemData(final Object object, int position);
     ...
     * @param payloads
     */
    protected void bindItemPartialData(int position, List<Object> payloads) {
    }
