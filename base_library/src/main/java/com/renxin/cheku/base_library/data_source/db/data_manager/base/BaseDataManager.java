package com.renxin.cheku.base_library.data_source.db.data_manager.base;
...
import com.renxin.cheku.base_library.data_source.db.db_manager.BaseDBManager;
...
public abstract class BaseDataManager {
    ...
    static UserInfoProvider mUserInfoProvider = (UserInfoProvider) ARouter.getInstance().build(RouterTable.PROVIDER_USER_INFO_PROVIDER_IMPL).navigation();
    ...
    protected static final boolean objIsNull(BaseDataManager object) {
        return object == null || !object.manager.getDatabaseName().equals(mUserInfoProvider.getAccount());
    }
