package com.renxin.cheku.base_library.model;
...
public class ReportData implements Serializable {
    public ReportData() {
        ...
        UserInfoProvider userInfoProvider = (UserInfoProvider) ARouter.getInstance().build(RouterTable.PROVIDER_USER_INFO_PROVIDER_IMPL).navigation();
        this.account = userInfoProvider.getAccount();
        if (TextUtils.isEmpty(this.account)) {
            this.account = "unlogin";
        }
        this.event_time = DateUtils.getFormatTimeStr(System.currentTimeMillis());
        uCompany = userInfoProvider.getCompanyName();
    }
