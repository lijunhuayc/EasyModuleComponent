package com.renxin.cheku.base_library.data_report;
...
import com.renxin.cheku.base_library.model.ReportData;
import com.renxin.cheku.base_library.utils.DESUtils;
...
import static com.renxin.cheku.base_library.model.BaseResult.STATUS_REPORT_CUSTOM_ERROR;
...
public class ReportWorkThread extends Thread {
    ...
    private List<ReportData> mDataQueue = Collections.synchronizedList(new ArrayList<>());
    ...
    private void writeToLocal() {
        ...
        if (FileUtils.writeFile(filePath, mGson.toJson(mDataQueue))) {
        ...
        while (!mQuit) {
            ...
            RetrofitUtils.getInstance().request(BaseLibraryAPIService.class, new RetrofitUtils.RetrofitCallback<BaseLibraryAPIService, String>() {
                ...
                public Call<BaseResult<String>> getAPI(BaseLibraryAPIService pT) {
                    ...
                    return pT.postDataReport(bodyContent);
                    /**
                     ...
                     * @see com.renxin.cheku.base_library.data_source.net.retrofit.converter.CustomResponseBodyConverter#convert(ResponseBody)
                     */
                }
