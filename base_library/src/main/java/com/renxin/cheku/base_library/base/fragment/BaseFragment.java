package com.renxin.cheku.base_library.base.fragment;
...
public abstract class BaseFragment extends Fragment {
    ...
    protected View fragmentRootView = null; // Fragment的根View
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fragmentRootView = inflater.inflate(initLayout(), container, false);
        mUnBinder = ButterKnife.bind(this, fragmentRootView);
    ...
    protected void showLoadingDialog() {
        ...
        if (null == mCoolLoadingDialog) {
            mCoolLoadingDialog = new CoolLoadingDialog.Builder(getContext())
                    .setCancelable(false)
                    .setMessage("努力加载中")
                    .create();
        }
