...
public class AppInfoModel {
    ...
    private String uniqueCode;//设备唯一编码(使用的 JPushInterface.getUdid )
    ...
    private static void initAppInfo(Context pContext) {
        ...
        try {
            ...
            if (info != null) {
                ...
                mAppInfoModel.uniqueCode = JPushInterface.getUdid(pContext);//使用JPush 生成的唯一设备编码
                ...
                Timber.d("about: uniqueCode = %s", mAppInfoModel.uniqueCode);
            }
