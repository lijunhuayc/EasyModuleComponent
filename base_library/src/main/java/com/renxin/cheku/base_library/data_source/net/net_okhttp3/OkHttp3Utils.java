...
import com.renxin.cheku.base_library.data_source.net.HttpURLAPI;
import com.renxin.cheku.base_library.data_source.net.HttpUtils;
import com.renxin.cheku.base_library.data_source.net.IHttpUtils;
import com.renxin.cheku.base_library.data_source.net.RequestCallBack;
import com.renxin.cheku.base_library.domain.MainThreadScheduler;
import com.renxin.cheku.base_library.model.BaseResult;
import com.renxin.cheku.base_library.utils.MD5Utils;
...
//        url = HttpURLAPI.convertAPIUrl(url);
        ...
        String requestTag = MD5Utils.MD5EncodeString((url + method + jsonParams).getBytes());
...
//        url = HttpURLAPI.convertAPIUrl(url);
    ...
    private Map<String, String> checkParams(Map<String, String> params) {
        ...
        params.put("token", mUserInfoProvider.getToken());
        return params;
    }
    ...
    private Request getRequest(int method, String url, Map<String, String> params) {
        ...
        if (method == HttpUtils.Method.METHOD_GET || method == HttpUtils.Method.METHOD_DELETE) {
            url = HttpURLAPI.buildGetURL(url, params);
        } else {
            url = url + "?token=" + mUserInfoProvider.getToken();
