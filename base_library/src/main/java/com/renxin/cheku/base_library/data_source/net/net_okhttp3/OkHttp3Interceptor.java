...
public class OkHttp3Interceptor implements Interceptor {
    ...
    private Request createNewRequest(Request pRequest) {
        HttpUrl.Builder builder = pRequest.url()
                ...
                .setEncodedQueryParameter("pid", mUserInfoProvider.getCurrentProvinceId() + "")
                .setEncodedQueryParameter("cid", mUserInfoProvider.getCurrentCityId() + "")
                .setEncodedQueryParameter("out", "json");
        /**
         * @see BaseLibraryAPIService#postDataReport(String)
         */
