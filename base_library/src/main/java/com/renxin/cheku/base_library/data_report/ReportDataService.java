...
import com.renxin.cheku.base_library.utils.DateUtils;
...
public class ReportDataService {
    ...
    public void report(ReportData data) {
        ...
        String account = mUserInfoProvider.getAccount();
    ...
    public void reportLoginEvent(String target) {
        ...
        data.addContent(new ReportData.ContentBean("account", mUserInfoProvider.getAccount(), "用户登录账号"));
        report(data);
    }
    ...
    public void reportExitEvent(String target) {
        ...
        data.setName("退出APP");
        data.setTarget(target);
        data.addContent(new ReportData.ContentBean("account", mUserInfoProvider.getAccount(), "用户退出登录账号"));
        report(data);
    }
