package com.renxin.cheku.base_library.widget;
...
import com.renxin.cheku.base_library.R;
import com.renxin.cheku.base_library.utils.ScreenUtils;
...
public class LibraryTitleView extends RelativeLayout {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int mBackgroundColor = a.getColor(R.styleable.LibraryTitleView_library_background_color, Color.parseColor("#0a355a"));
...
//            TypedArray b = context.obtainStyledAttributes(attrs, systemAttrs);
//            mHeight = b.getDimensionPixelSize(0, ViewGroup.LayoutParams.WRAP_CONTENT);
//            b.recycle();
//        }
        mBackTipsEnable = a.getBoolean(R.styleable.LibraryTitleView_library_back_tips_enable, false);
        mBackIcon = a.getResourceId(R.styleable.LibraryTitleView_library_back_icon, R.drawable.library_common_back_icon_white);
        ...
        mTitleColor = a.getColor(R.styleable.LibraryTitleView_library_title_color, Color.parseColor("#FFFFFF"));
        mMenuText = a.getString(R.styleable.LibraryTitleView_library_menu_text);
        mMenuTextColor = a.getColor(R.styleable.LibraryTitleView_library_menu_text_color, Color.parseColor("#FFFFFF"));
